...
public class PreFilter2 extends ZuulFilter {
     ...
     * 日志
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(PreFilter2.class);
    ...
    public Object run() throws ZuulException {
        LOGGER.info("Start Call PreFilter2......");
        LOGGER.info("PreFilter2 order is 2");
        RequestContext ctx = RequestContext.getCurrentContext();
        HttpServletRequest request = ctx.getRequest();
        HttpServletResponse response = ctx.getResponse();
        LOGGER.info("send {} request to {}", request.getMethod(), request.getRequestURL().toString());

        LOGGER.info("End Call PreFilter2......");
        return null;
    }
}
